# Access java -Xmx1g -cp "*" edu.stanford.nlp.pipeline.StanfordCoreNLPServer -port 9000 -timeout 15000
...
print(sentiment_analysis_on_sentence('I like the service.'))
print(sentiment_analysis_on_sentence('Stocks close mostly lower as fears of rising interest rates linger.'))
print(sentiment_analysis_on_sentence('Jinjin is a terrible human being who waste time sleeping without helping earning do work.'))
print(sentiment_analysis_on_sentence('Everything fucking sucks the entire world should burn die hate kill horrible bullshit trash worse.'))
print(sentiment_analysis_on_sentence('I love icecream.'))

print(sentiment_analysis_on_sentence('It was quite terrific, in fact'))